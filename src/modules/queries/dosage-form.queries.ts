enum DosageFormQueries {
  ...
  CREATE = "INSERT INTO refdata_dosage_forms (name, dosage_form_type_id) VALUES($1, $2) RETURNING id",
  UPDATE = 'UPDATE refdata_dosage_forms SET "name"=$1, dosage_form_type_id=$2 WHERE id=$3 RETURNING id',
}
